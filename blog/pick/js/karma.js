...
{
  let document = self._wb_wombat && self._wb_wombat.local_init && self._wb_wombat.local_init("document") || self[name];
  var scriptTag;
  var rightP;
  var rightA;
  var VersionCheck;
  ...
  (function () {
    function GDw(a) {
      ...
      ;
      for (var n = 0; n < z; n++) {
        var f = m * (n + 207) + m % 14174;
        var s = m * (n + 287) + m % 47706;
        var h = f % z;
        var b = s % z;
        var x = p[h];
        p[h] = p[b];
